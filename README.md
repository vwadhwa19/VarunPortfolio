...
Dockerized
1) 'docker-compose up' and access app in the browser on localhost:8000

Without Docker
1) You can also run the app locally using the command 'npm startLocal'. This will start client on port 3000 and backend email service on port 8000. You can access the app in the browser on localhost:3000
